...
prepend QT_PLUGIN_PATH $KDEDIR/%{_lib}/qt4/plugins
prepend QT_PLUGIN_PATH $KDEDIR/%{_lib}/kde4/plugins

prepend LD_LIBRARY_PATH $KDEDIR/%{_lib}
export LD_LIBRARY_PATH
prepend PKG_CONFIG_PATH $KDEDIR/%{_lib}/pkgconfig
export PKG_CONFIG_PATH

export CMAKE_PREFIX_PATH=$KDEDIR
export CMAKE_INSTALL_PREFIX=$KDEDIR
export CMAKE_LIBRARY_PATH=$KDEDIR/%{_lib}
